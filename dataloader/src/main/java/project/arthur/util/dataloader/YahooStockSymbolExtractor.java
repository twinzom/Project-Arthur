...
public class YahooStockSymbolExtractor {

	/*
	 * Extract symbol from pre-downloaded yahoo stock information
	...
	public static void main(String[] args) throws Exception {
		...
		String OUTPUT_FILE = System.getProperty("user.home")+"/Projects/git/Project-Arthur/dataloader/datafile/yahoo/yahoo_stocks_list.txt";
